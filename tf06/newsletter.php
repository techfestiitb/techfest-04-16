...
echo "<div id=content>";
echo "<h1 id=toptext>Newsletter Subscription Status</h1><br>";
 
if(!(isset($_POST['news_email']))||($_POST['news_email']==""))
 {
...
$query="SELECT * FROM newsletter2006 WHERE (email LIKE '{$_POST['news_email']}')";     
...
if ($r)
 {
	print "<p>This entry already exists</p>";
...
else if(!$k)
	 {
		...
		echo " <p>The email address is wrong.</p>"; 
		
	 }
 
else
{
$query="INSERT INTO newsletter2006 VALUES ('{$_POST['news_email']}')";
$result=mysql_query($query);
if (!$result)
        {
...
<div id="content" style="background-color: #F2F2F2;	MARGIN: 20px 0px 0px 0px;	line-height: 1.4em; ">
...
<div class="border" style="border: 1px solid #DFDEDE;	background-color: #FFF; "> 
	...
	text-transform:none;"> A.I.</h2> 
		...
		<div class="paddingcontent" style="PADDING: 7px 10px 7px 10px;	MARGIN: 0px;	border-top: 1px solid #F7F7F7;border-left: 1px solid #F7F7F7;LIST-STYLE-TYPE: none;	background-color: #FFF;border-bottom: none;PADDING: 10px 20px 3px 23px;">
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Micromouse - Masters of the Maze</h3>
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; color:#5a595a;">Character Recognition</h3>
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Crux</h3>
	...
	text-transform:none;"> CONCREaTE</h2> 
      	...
      	<div class="paddingcontent" style="PADDING: 7px 10px 7px 10px;	MARGIN: 0px;	border-top: 1px solid #F7F7F7;border-left: 1px solid #F7F7F7;LIST-STYLE-TYPE: none;	background-color: #FFF;border-bottom: none;PADDING: 10px 20px 3px 23px;"> 
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">H</h3> 
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Bridged</h3>
	...
	text-transform:none;"> Cosmos</h2> 
      	...
      	<div class="paddingcontent" style="PADDING: 7px 10px 7px 10px;	MARGIN: 0px;	border-top: 1px solid #F7F7F7;border-left: 1px solid #F7F7F7;LIST-STYLE-TYPE: none;	background-color: #FFF;border-bottom: none;PADDING: 10px 20px 3px 23px;"> 
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">G.R.I.P.</h3> 
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Black Box</h3>
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">ASU\'s Mars Rover Exhibition</h3>
	...
	text-transform:none;">e - Rustique</h2> 
      	...
      	<div class="paddingcontent" style="PADDING: 7px 10px 7px 10px;	MARGIN: 0px;	border-top: 1px solid #F7F7F7;border-left: 1px solid #F7F7F7;LIST-STYLE-TYPE: none;	background-color: #FFF;border-bottom: none;PADDING: 10px 20px 3px 23px;"> 
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">The Simple Life v1.1</h3> 
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Agrobot</h3>
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Innovision</h3>
	...
	text-transform:none;">Sixth Gear</h2> 
      	...
      	<div class="paddingcontent" style="PADDING: 7px 10px 7px 10px;	MARGIN: 0px;	border-top: 1px solid #F7F7F7;border-left: 1px solid #F7F7F7;LIST-STYLE-TYPE: none;	background-color: #FFF;border-bottom: none;PADDING: 10px 20px 3px 23px;"> 
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Full Throttle</h3> 
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Hover - Junior</h3> 
	...
	text-transform:none;">Smart Tech</h2> 
		...
		<div class="paddingcontent" style="PADDING: 7px 10px 7px 10px;	MARGIN: 0px;	border-top: 1px solid #F7F7F7;border-left: 1px solid #F7F7F7;LIST-STYLE-TYPE: none;	background-color: #FFF;border-bottom: none;PADDING: 10px 20px 3px 23px;"> 
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">iClean</h3> 
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Prayaas</h3> 
			...
			<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Home Alive</h3>
	...
	text-transform:none;">Lecture Series</h2> 
		...
		<div class="paddingcontent" style="PADDING: 7px 10px 7px 10px;	MARGIN: 0px;	border-top: 1px solid #F7F7F7;border-left: 1px solid #F7F7F7;LIST-STYLE-TYPE: none;	background-color: #FFF;border-bottom: none;PADDING: 10px 20px 3px 23px;"> 
		<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Dr. Amar Bose, Founder-CEO of Bose Corporation (USA) </h3>
		...
		<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Dr. Sam Pitroda, (Chairman, WorldTel Limited, UK; and Chairperson National Knowledge Commission, India)</h3>
		...
		<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Also Prof Rodney Brooks, Director of MIT\'s Computer Science and Artificial Intelligence Labs(CSAIL)  and Fujitsu Professor of Computer Science</h3>
		...
		<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Prof Anil K Gupta, (exec- Vice Chairman National Innovation Foundation, also holding the Kasturbhai Lalbhai Chair in Entrepreneurship, IIM Ahmedabad)</h3>
		...
		<h3 style="font-family: Georgia, Times, serif;	font-weight: bold;	font-size: 11px;	MARGIN: 0px;PADDING: 1.2em 0px 1em 0px; clor:#5A595A;">Dr. Eric Mathews - The man who has designed the PKD Android</h3>
		...
		For more information regarding Techfest \'06 - events, rules, registrations and any clarifications at all, please visit our website <a style="COLOR: #00A2FF;" href="http://www.techfest.org" target="_blank">www.techfest.org</a><br> or mail us at <strong>info@techfest.org</strong> .
		</div>
...
$h = mail($_POST['news_email'], $sub, $mes, $headers);

	}
        $fp=fopen("./subscribe.txt","a+");
        fwrite($fp,$_POST['news_email']."\n"); 
        fclose($fp);
