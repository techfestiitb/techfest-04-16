...
{
?>
<form method=POST action=mail_harki_space.php>
<br><center><centre>
...
?>
<br><br><form method="POST" action="mail_harki_space.php">
...
<form method="POST" action="<?php echo $PHP_SELF ?>">
  <p>
  Registration number:<input type=text name=start_text><br>
  <b>All mails with registration numbers mentioned above will be sent. Write all registration 
nubers separated by space
<br></b>
...
if($start_text=="")
{
echo "No registration number";
exit;
}
$start=0;
$regnumber=$code.$list[$start];
