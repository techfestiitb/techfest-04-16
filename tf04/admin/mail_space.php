...
{
?>
<form method=POST action=mail_space.php>
<br><center><centre>
...
?>
<br><br><form method="POST" action="mail_space.php">
...
jaaeyga<br>
<p>  
Registration Numbers:<input type=text name=start_text><br>
Just enter all registrations numbers separated by space.<br>
...
if($start_text == "") {
echo "<br><br>No Numbers Given ...dude :)  ";
exit;
}
