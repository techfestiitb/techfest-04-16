...
HM_GL_FontColor          = "#15446a";
HM_GL_FontColorOver      = "#16233d";
HM_GL_BGColor            = "#ECEEED";
HM_GL_BGColorOver        = "#ECEEED";
HM_GL_ItemPadding        = 3;

HM_GL_BorderWidth        = 1;
HM_GL_BorderColor        = "#15446a";
HM_GL_BorderStyle        = "solid";
HM_GL_SeparatorSize      = 0;
HM_GL_SeparatorColor     = "#ECEEED";
...
//	HM_BrowserString = HM_NS4 ? "NS4" : HM_DOM ? "DOM" : "IE4";
	...
	document.write("<SCR" + "IPT LANGUAGE='JavaScript1.2' SRC='" + HM_ScriptDir + "HM_ArraysFrames.js' TYPE='text/javascript'><\/SCR" + "IPT>");
