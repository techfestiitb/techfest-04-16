...
"Colosseum	 ", "javascript:mnu('main.php?file=technoholix/coll.php')",0,
...
"Open Competitions  ","javascript:mnu('main.php?file=competitions/opencompetitions.php')",1,
...
"Technumopus", "javascript:mnu('main.php?file=chemsplash/technum.php')",0
);
arMenu1_2 = new Array(
...
arMenu1_9 = new Array(
"Crane Building","javascript:mnu('main.php?file=laststraw/crane.php')",0,
"Impact Loading","javascript:mnu('main.php?file=laststraw/impact.php')",0,
...
"Car Technology","javascript:mnu('main.php?file=workshops/car.php')",0,
"Wings","javascript:mnu('main.php?file=workshops/wings.php')",0,
"r U GAME","javascript:mnu('main.php?file=workshops/game.php')",0,
"GPS/GIS","javascript:mnu('main.php?file=workshops/gps.php')",0,
"Smart Materials","javascript:mnu('main.php?file=workshops/smart.php')",0
)
...
"Navy Exhibition	","javascript:mnu('main.php?file=events/naval.php')",0,
"Tech-a-Tete		","javascript:mnu('main.php?file=lectureseries/lecture.php')",0,
"Tech-a-Break	 ","javascript:mnu('main.php?file=events/hub.php')",0,
