<?php
include('http://www.techfest.org/box.php?text=KURUKSHETRA');
?><a name=back></a><br>
<span style="margin-top:4 px">
<font color=#293932><b>A PHENOMENON WHICH WILL TAKE YOU BY STORM..... </b></font></span><br><br>
<img src=competitions/kurukshetra/upload1.jpg border=0 hspace=20 vspace=20 align=right>
...
Total Cash Prize of Rs. <b>12,000</b> to be won.  <br><br>
  ...
  <a href=main.php?file=competitions/kurukshetrascoring.php#create class=greylink>Making Your Robots</a><br>
  <a href=main.php?file=competitions/kurukshetrascoring.php#scoring class=greylink>Scoring Strategy</a><br>
...
class=greylink href=register/allregister1.php?comp=kur>Register</a><br>
  <br><br> <a name=prob><font color=#293932><b>PROBLEM
...
href=competitions/kurukshetra.zip class=greylink target=_blank>ZIP
file</a> of the environment (battle arena). For help related to installing
and running the environment, please refer to the <a
href=main.php?file=competitions/kurukshetrainstall.php
class=greylink>installer help</a>.<br><br></li><li> In our endeavor to
...
href=competitions/kurukshetra/index.html target=_blank 
...
<a href=main.php?file=competitions/kurukshetrascoring.php#scoring 
...
href=competitions/kurukshetra.zip class=greylink>Download the zip file of
the environment</a> (last updated on 5th Jan.) </li> <li><a target=_blank
href=competitions/kurukshetra.pdf class=greylink>Download rules in pdf
format</a>&nbsp;<img src=media/pdficonsm.gif alt="Adobe Icon"></li><li><a href=competitions/kurukshetra/docs.zip class=greylink tearget=_blank>Download the 
list of functions</a></li> 
<li><a href=competitions/kurukshetrainstall.pdf
target=_blank class=greylink>Installation Helps in pdf format</a>&nbsp;<img src=media/pdficonsm.gif alt="Adobe Icon"></li>
<li><a href=competitions/submit.zip
