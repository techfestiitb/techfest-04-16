<?php
  ...
  $PHORUM['ForumName']='Competitions';
  $PHORUM['ForumDescription']='all your queries about competitions will be answered here';
  $PHORUM['ForumConfigSuffix']='comp';
  $PHORUM['ForumFolder']='0';
  $PHORUM['ForumParent']='0';
  $PHORUM['ForumLang']='lang/english.php';
  $PHORUM['ForumDisplay']='30';
  $PHORUM['ForumTableName']='boardcomp';
