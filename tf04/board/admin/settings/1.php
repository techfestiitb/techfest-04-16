<?php
  ...
  $PHORUM['ForumName']='Techfest 2002';
  $PHORUM['ForumDescription']='General queries and suggestions about Techfest 2002.';
  $PHORUM['ForumConfigSuffix']='tf';
  $PHORUM['ForumFolder']='0';
  $PHORUM['ForumParent']='0';
  $PHORUM['ForumLang']='lang/english.php';
  $PHORUM['ForumDisplay']='30';
  $PHORUM['ForumTableName']='board1';
