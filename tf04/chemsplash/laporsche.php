<?php include('http://www.techfest.org/box.php?text=la%20porsChe'); ?><br> <p>The year is 2296 A.D. Earth. After the 4th
...
class=greylink target="_blank">Download Rules</a>&nbsp;<img src="media/pdficonsm.gif"   alt="Adobe icon"><br> 
<a 
href=http://www.techfest.org/register/allregister1.php?comp=por 
target=midFrame class=greylink>Register</a><br>
...
engines (combustion engines) etc. are not allowed as power sources.
<br><br></li>
...
chemical reaction.<br><br></li>

<li>The car must carry a container that holds up to 200 ml of water without spilling. At the competition, only the water
will be supplied, thus each car must already have its own container.<br><br></li> <li>All components of the car must fit
into a shoebox of dimensions no larger than 40 cm x 30 cm x 18 cm. The car may be disassembled to meet this requirement.
If the judges are uncertain whether the car will fit inside the box when disassembled, they may request the team to
demonstrate that they can do this.<br><br></li>

<li>Students are responsible for transportation of the chemicals to the competition sites. Students are also responsible
for arranging for the disposal of their chemicals and wastes. The possibility of on-site waste disposal will be posted
here, if available.<br><br></li> 
...
<li>Posters will carry weightage of 20% and will be judged according to the following criteria (equal weightage):  <ul>
...
violations have occurred, the judges have the discretion to disqualify the entry.<br><br></li> <li>If a car is deemed
...
information on where chemicals may be stored at the competition site: <a href=main.php?file=chemsplash/chemsplash.php
