...
//echo "$start";
//echo "$end";
$query="SELECT * FROM powerboats2k5 WHERE (Regnum <=$end && Regnum >= $start)"; 
$result=mysql_query($query) or die ("Error in query") .mysql_error();

$mes.="This is in regard to Techfest 2005, the annual science and technology festival of IIT Bombay. This is to inform you that your participation in the event Power Boats has been confirmed\r\n";
...
//	$row1=mysql_fetch_row($result1);
	...
	$mes1.="Registration Number : YP05".$row[0]." \r\n";
