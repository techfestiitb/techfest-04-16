...
//echo "$start";
//echo "$end";
$query="SELECT * FROM micromouse2k5 WHERE (Regnum <=$end && Regnum >= $start)"; 
$result=mysql_query($query) or die ("Error in query") .mysql_error();

$mes.="This is in regard to Techfest 2005, the annual science and technology festival of IIT Bombay. This is to inform you that your participation in the event Micromouse has been confirmed\r\n";
...
//	$row1=mysql_fetch_row($result1);
	...
	$mes1.="Registration Number : YM05".$row[0]." \r\n";
	$mes1.="Contingent Leader : ".$row[1]." \r\n";
	$mes1.="Email : ".$row[2]."  \r\n";
	$mes1.="University : ".$row[3]."  \r\n";
	$mes1.="\r\nTeam Members :\r\n";
	for ($i=5;$i<$columns && $i<17;$i+=4) $mes1.=$row[$i]."\r\n";
	$mes1.="Address: ".$row[17]."\r\n\r\n\r\n\r\n";	
	$mes2.=$mes1;
