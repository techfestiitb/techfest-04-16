...
?>
	...
	<form method="POST" ENCTYPE="multipart/form-data" action="./tempfile.php">
	...
	while($row=mysql_fetch_row($result))
	 {
		...
		$mes="Hi\r\n\r\nWe are pleased to inform you that your participation has been confirmed for ".$_POST['namecomp'].". Congratulations for the same.";
		$mes.="\r\n\r\nAccommodation has been confirmed for the following participants:";
		...
		$mes.="\r\n\r\n4. An accommodation fee of Rs.200/- and a refundable security deposit of Rs.50/- will be charged per head at the time of the fest. You will be required to pay Rs.200/- + Rs.50/- = Rs.250/- in cash at the time of check-in. ";
		
		$mes.="\r\n\r\n5. Accommodation will be provided on sharing basis.";
		
		$mes.="\r\n\r\n6. We shall provide you with mattresses and buckets. However, you are encouraged to carry your own blankets since it might be a little cold at night.";

		$mes.="\r\n\r\n7. For Yantriki, Laststraw, Udaan, Chemsplash, CRO 1.0 and Contraption participants, please note that all of you will be required to display your machine at the Competitions Desk, which will be located besides the Accommodation desk, in order to avail accommodation. ";
		
		$mes.="\r\n\r\n8. Those carrying their CPU, laptop or any other expensive electronic gadgets will have to get their 'Gate Pass' from the IIT Bombay Main Gate at the time of check-in.";
		
		$mes.="\r\n\r\nHow to get to IIT Powai, Mumbai\r\nPlease visit www.techfest.org/assistance for transportation details. ";
	
		$mes.="\r\n\r\n1. IIT buses will ply from Dadar station to IIT to escort the contingents. Kindly inform us about your itinerary in advance to enable us to provide this facility to you.";
