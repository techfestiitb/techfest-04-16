...
?>
	...
	<form method="POST" ENCTYPE="multipart/form-data" action="./postabstract.php">
	...
	while($row=mysql_fetch_row($result))
	 {
		...
		$mes="Hi\r\n\r\nWe are pleased to inform you that your team has been selected for ".$_POST['namecomp'].". Congratulations for the same.";
